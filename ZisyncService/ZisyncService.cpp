...
BEGIN_MESSAGE_MAP(CZisyncServiceApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CZisyncServiceApp construction

CZisyncServiceApp::CZisyncServiceApp()
{
...
// The one and only CZisyncServiceApp object

CZisyncServiceApp theApp;


// CZisyncServiceApp initialization

BOOL CZisyncServiceApp::InitInstance()
{
...
int CZisyncServiceApp::ExitInstance()
{
