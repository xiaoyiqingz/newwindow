...
BEGIN_MESSAGE_MAP(CZisyncServiceDlg, CMyDialog)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_ERASEBKGND()
	ON_BN_CLICKED(IDC_BUTTON4, &CZisyncServiceDlg::OnClickedButton4)
...
//	LoadBackSkin(_T("G:\\vstest\\NewWindow\\ZisyncService\\res\\back.jpg"));
...
void CZisyncServiceDlg::InitEdit()
{
...
void CZisyncServiceDlg::OnClickedButton4()
{
