// Zisync.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CZisyncApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CZisyncApp construction

CZisyncApp::CZisyncApp()
{
...
// The one and only CZisyncApp object

CZisyncApp theApp;


// CZisyncApp initialization

BOOL CZisyncApp::InitInstance()
{
